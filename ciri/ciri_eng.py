...
def _ciri_eng(args, input_path: str, output_path: str):
    print("[Ciri] Start")
    ...
    ciri_runner(args, file_content=input_file_content, output_path=output_path)
...
def ciri_eng(args: Dict):
    ...
    if os.path.isdir(input_path):
        ...
        for file_name in file_list:
            ...
            _ciri_eng(args, input_file_loc, output_file_loc)
